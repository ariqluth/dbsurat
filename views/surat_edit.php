                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="perihal" value="<?=$data['perihal']?>"class="form-control" id="inputEmail3" placeholder="Perihal">
                            </div>
                        </div>
						<div class="form-group">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE surat_masuk SET nama_penerima='$nama_penerima',tgl_masuk='$tgl_masuk',nama_pengirim='$nama_pengirim',instansi='$instansi',perihal='$perihal',status='$status' WHERE no_surat ='$no_surat'"; 
