            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
					...
					<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="varchar" name="nama_penerima" value="<?=$data['nama_penerima']?>"class="form-control" id="inputEmail3" placeholder="Nama Penerima">
                            </div>
                        </div>
					<div class="form-group">
                            <label for="instansi" class="col-sm-3 control-label">Instansi</label>
                            <div class="col-sm-9">
                                <input type="varchar" name="instansi" value="<?=$data['instansi']?>"class="form-control" id="inputEmail3" placeholder="Instansi">
                            </div>
                        </div>	
                    <div class="form-group">
                            <label for="perihal" class="col-sm-3 control-label">Perihal</label>
                            <div class="col-sm-9">
                                <input type="text" name="perihal" value="<?=$data['instansi']?>"class="form-control" id="inputEmail3" placeholder="Perihal">
                            </div>
                    </div>  
                    <div class="form-group">
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE surat_keluar SET nama_pengirim='$nama_pengirim',tgl_keluar='$tgl_keluar',nama_penerima='$nama_penerima',instansi='$instansi' WHERE no_surat ='$no_surat'"; 
